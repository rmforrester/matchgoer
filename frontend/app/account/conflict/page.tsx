...
export default async function AccountConflictPage({ searchParams }: { searchParams: Promise<{ returnTo?: string }> }) {
  ...
  return <AccountShell kicker="Signed in" title="You're signed in" intro="There's also Terrace Talk activity on this device that isn't attached to this account yet.">
