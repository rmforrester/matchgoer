...
export default function AuthTestClient() {
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
      <p className="text-sm font-bold uppercase tracking-widest text-[var(--brand-interactive)]">Development only</p>
      ...
      <form onSubmit={signUp} className="mt-6 grid gap-4 border-2 border-neutral-900 p-4">
        ...
        <div className="flex flex-wrap gap-3">
          <button disabled={busy} className="min-h-11 border-2 border-neutral-900 bg-[var(--brand-interactive)] px-4 font-black uppercase text-white disabled:opacity-50" type="submit">Sign up</button>
      ...
      <section className="mt-6 border-2 border-neutral-900 p-4">
        ...
        <button disabled={busy || !providerSession} className="mt-4 min-h-11 border-2 border-neutral-900 bg-[var(--brand-interactive)] px-4 font-black uppercase text-white disabled:opacity-50" type="button" onClick={claim}>Claim anonymous user</button>
